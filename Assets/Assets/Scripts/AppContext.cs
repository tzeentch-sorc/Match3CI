...
public class AppContext : MonoBehaviour, IAppContext
{
    ...
    [Space]
    [SerializeField] private IconsSetModel _iconSet;
    ...
    public void Construct()
    {
        ...
        RegisterInstance<IBoardFillStrategy<IUnityGridSlot>>(GetBoardFillStrategy());
    }
    ...
    private UnityGame GetUnityGame()
    {
        var gameConfig = new GameConfig<IUnityGridSlot>
        {
            ...
            LevelGoalsProvider = new LevelGoalsProvider(_gameUiCanvas),
    ...
    private IBoardFillStrategy<IUnityGridSlot> GetBoardFillStrategy()
    {
        return new FallDownFillStrategy(this);
    }
}