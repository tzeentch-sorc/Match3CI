...
namespace Common.GameModes
{
    public class GameInitMode : IGameMode, IDisposable
    {
        ...
        private readonly IconsSetModel _iconSet;
        ...
        public GameInitMode(IAppContext appContext)
        {
            ...
            _iconSet = appContext.Resolve<IconsSetModel>();
        ...
        public void Activate()
        {
            ...
            {
                u.enabled = true;
                u.hpUi.text = u.unitTypeString + u.hpCount;
            }
        ...
        private void SetLevel(int level)
        {
            ...
            _itemGenerator.SetSprites(_iconSet.Sprites);
        }
    }
}