...
public class GridCombatSystem : MonoBehaviour {
	...
	[SerializeField] public UnitGridCombat[] unitGridCombatArray;
    ...
    private void SelectNextActiveUnit() {
		...
		Vector2Int UnitPos = GridPathfinding.instance.GetConvertedVectorPosition(unitGridCombat.GetPosition());
        
        GridPathfinding.instance.SetWalkable(UnitPos.x, UnitPos.y, true);
    ...
    private void UpdateValidMovePositions() {
		...
		//reset gridPathfinding
		gridPathfinding.SetAllWalkable(true);
        gridPathfinding.RaycastWalkable();
		
        foreach(var unit in unitGridCombatArray)
        {
			grid.GetXY(unit.GetPosition(), out int _unitX, out int _unitY);
			gridPathfinding.SetWalkable(_unitX, _unitY, false);
        }
        
        gridPathfinding.SetWalkable(unitX, unitY, true);

		int maxMoveDistance = unitGridCombat.MaxWalkDistance+1;
                ...
                if (Input.GetMouseButtonDown(0)) {
                    ...
                    if (gridObject.GetIsValidMovePosition()) {
                        ...
                        if (canMoveThisTurn) {
                            ...
                            GridPathfinding.instance.SetWalkableWorldPos(unitGridCombat.GetPosition(), true);
