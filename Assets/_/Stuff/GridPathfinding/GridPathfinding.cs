...
namespace GridPathfindingSystem {
    ...
    public class GridPathfinding {
		...
		public void SetWalkableWorldPos(Vector3 position, bool walkable)
		{
            Vector2Int mapPos = GetConvertedVectorPosition(position);
            SetWalkable(mapPos.x, mapPos.y, walkable);
		}
		...
		public Vector2Int GetConvertedVectorPosition(Vector3 position)
		{
			ConvertVectorPositionValidate(position, out int x, out int y);
